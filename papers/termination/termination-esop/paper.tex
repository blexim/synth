...
\title{Termination and Non-Termination Proofs for Bit-Vector Programs}
...
We present a reduction from program \emph{termination} to 
second-order satisfiability. 
%program
%\emph{synthesis} via a fragment of second-order logic.  
We give formulations for termination and non-termination in a fragment of second-order logic 
with restricted quantification.

existential second-order logic over finite domains is decidable \cite{kalashnikov}. 

% decidable for finite-state programs 
...
%
%
This second-order SAT solver is a semi-decision procedure -- for any
...
We omitted exactly those SVCOMP'15
