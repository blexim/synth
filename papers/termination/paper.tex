...
%% computing the under-approximation of the loop's body requires an extra quantifier alternation. 
%% The origin of the problem comes from the fact that an under-approximation is an existential property and therefore
