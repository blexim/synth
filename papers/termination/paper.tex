...
$2^bk$ times and each iteration requires solving 2 NP-complete problems of size < $2^bk \times \| L\|$
with $\| L \| $ the size of the program-under-analysis computing $\| L \|$.  So the
runtime is bounded by $2^{bk+1} NP(2^bk \| L \|)$.
