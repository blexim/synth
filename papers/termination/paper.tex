...
Now, we provide some simple examples that broke those assumptions and cannot therefore be handled by state of the art tools.
...
Figure~\ref{fig:handletable} shows that the first assumption is that programs are linear.
