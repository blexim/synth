...
$R$ is a ranking function that proves the loop $L$ terminates, so the termination of $L$
is equivalent to the satisfiability of Definition~\ref{def:termination-formula}.
...
Consider the following program with two loops $L_1$ and $L_2$:
