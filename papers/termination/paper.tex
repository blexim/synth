...
For our case, given a loop $L = \langle I,G,T \rangle$, the notion of open recurrent set is encoded by Definition~\ref{def:nonterm-formula}.
...
visited twice in the course of the execution. Hence, an alternative formulation of the non-termination problem 
for bit-vectors may search for a state that is visited twice.
