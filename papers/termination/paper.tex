...
With our technique we can find a non-linear lexicographic ranking function $R(x) = ...$.
...
Basically, when proving program termination we are simultaneously solving two problems:
...
We represent programs as transition systems with state space $X$ and transition relation $T \subseteq X \times X$. 
