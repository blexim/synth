...
insufficient for prove termination for many terminating programs, and
...
proofs.  Our encoding uniformly multiple loops and nested loops, without
having to enumerate lassos.
%
