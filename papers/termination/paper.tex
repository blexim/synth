...
ground terms.  This class of formulae is the same as the class of program synthesis formulae.
...
\begin{definition}[Synthesis Formula]
 ...
 $$\exists \vec{P}, \vec{x} \cdotp \forall \vec{y} \cdotp \sigma(\vec{x}, \vec{P}, \vec{y}) $$
\end{definition}
...
$T$ with initial states I.  This specification is defined in Definition~\ref{def:termination-spec}.
