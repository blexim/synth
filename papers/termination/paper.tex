...
The formula requires an auxiliary assertion $S(\mathcal{V},\mathcal{V}')$ representing a binary relation between the initial states at the inner loop's entry point
...
$\neg G_1(\mathcal{V}) \wedge P_1(\mathcal{V},\mathcal{V}') \rightarrow I(\mathcal{V}')$.
