...
A solution to the formula would include witnesses $P_N$ and $P_T$, which are proofs of non-termination
and termination respectively.  Exactly one of these proofs will be valid, so we can check
