...
To generate candidate solutions in the synthesise phase of the refinement loop,
we can use genetic programming (GP).  The general idea is to start with a population
