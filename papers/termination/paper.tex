...
termination abilities if you are willing to wait for it.
...
3.  Of these 3 timeouts, 2 (svcomp40 and svcomp41) are due program constants that
...
for both these benchmarks in less than 30s (but these results are not shown in
the table).
