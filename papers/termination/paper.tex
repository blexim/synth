...
Additionally, if the program under analysis is non-terminating and has a
non-deterministic transition relation, our procedure is not guaranteed to find a non-termination proof.
