...
void test_lookups() {
  ...
  concrete_heapt heap11 = {
    .succ={ INF, 1, 3, 1 }, .ptr={ 0, 1, 3, 2 }
  };
  test_lookup(&heap11);

  concrete_heapt heap12 = {
    .succ={ INF, 0, 1, 0 }, .ptr={ 0, 0, 3, 1 }
  };
  test_lookup(&heap12);

  concrete_heapt heap13 = {
    .succ={ INF, 3, 3, 2 }, .ptr={ 0, 3, 2, 1 }
  };
  test_lookup(&heap13);


  concrete_heapt heap14 = {
    .succ={ INF, 0, 0, 1 }, .ptr={ 0, 2, 2, 3 }
  };
  test_lookup(&heap14);


  concrete_heapt heap15 = {
    .succ={ INF, 3, 1, 1 }, .ptr={ 0, 0, 1, 2 }
  };
  test_lookup(&heap15);
...
void test_updates() {
  ...
  concrete_heapt heap10 = {
    .succ={ INF, 3, 1, 0 }, .ptr={ 0, 3, 1, 2 }
  };
  test_update(&heap10);

  concrete_heapt heap11 = {
    .succ={ INF, 2, 3, 1 }, .ptr={ 0, 3, 0, 1 }
  };
  test_update(&heap11);


  concrete_heapt heap12 = {
    .succ={ INF, 2, 2, 3 }, .ptr={ 0, 3, 2, 1 }
  };
  test_update(&heap12);


  concrete_heapt heap13 = {
    .succ={ INF, 0, 0, 0 }, .ptr={ 0, 3, 2, 1 }
  };
  test_update(&heap13);


  concrete_heapt heap14 = {
    .succ={ INF, 2, 0, 1 }, .ptr={ 0, 3, 2, 1 } 
  };
  test_update(&heap14);
  ...
  concrete_heapt heap10 = {
    .succ={ INF, 4, 0, 4, 0 }, .ptr={ 0, 2, 1, 1, 3 }
  };
  test_update(&heap10);


  concrete_heapt heap15 = {
    .succ={ INF, 4, 1, 2, 2 }, .ptr={ 0, 1, 3, 2, 4 }
  };
  test_update(&heap15);
