...
word_t update_tests[NUPDATE][NARGS] = {
  ...
  { 0, 1596982529, 1596982017, 147848447, 0, 1744830464, 147848959, 512, 0 },
  { 0, 4294967295, 4294967295, 4294967295, 0, 4294967295, 2147483647, 2147483647, 0 }
};
...
word_t lookup_tests[NLOOKUP][NARGS] = {
  ...
  { 0, 0, 1, 0, 0, 1, 4294705150, 4294705150, 0 },
  { 0, 2147483648, 2147483649, 4294967295, 0, 1, 4294967295, 4294967295, 0 },
};
