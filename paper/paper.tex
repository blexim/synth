...
exceptionally fruitful, beginning with Alonso Church's work on the
\emph{Circuit Synthesis Problem} in the sixties.  In this paper, we present
a new method that brings the promise of automating programming closer to
application.



\section{Related Work}
The most similar work to ours is {\sc brahma}~\cite{brahma}, which is also a method for
