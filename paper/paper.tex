...
bounded model checking and explicit state model checking.  The user provides a
specification in plain C, after which the synthesis process is fully automatic.
