...
This happens in 4 of the 29 cases.  This case is illustrated by benchmark p29, shown in Fig.~\ref{fig:obfuscated}.
...
minimal programs.  We performed a Mann-Whitney U-test (see Fig.~\ref{fig:stats-table})
to determine whether there was a significant difference
in the speed of the two tools.  The test was unable to reject the null hypothesis
(that the tools are equally fast) at the p=0.05
level, i.e. there is no statistically significant difference in the speed of
the two tools on this set of benchmarks.
