...
\begin{itemize}
 ...
 by the user.
 \item $P$ is written in a simple RISC-like language $\mathcal{L}$, described in Fig.~\ref{fig:l-language}.  Programs in $\mathcal{L}$
...
\section{Parametrisation of the Program Space}
...
we were not able to obtain a copy of {\sc Brahma}, and so were unable to repeat the experiments ourselves.}.
