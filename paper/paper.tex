...
work in the logic of quantifer-free propositional formulae and to use a
...
fragment of C as our underlying logic.  The fragment we use has the
...
language with the nice property that safety is decidable using a single
query to a bounded model checker.  We will refer to this fragment as \newC. 
...
\newC programs by using a bounded model checker.  A \newC program is just a C program
