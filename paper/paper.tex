...
\caption{Times for synthesis of machine integer benchmarks from {\sc brahma} PLDI paper}
...
\caption{Times for synthesis of machine integer benchmarks from {\sc brahma} ICSE paper}
