...
enoding of~\cite{brahma}, which generates a $\exists \forall$ formula
...
\subsection{$c$: Number of Constants}
...
TODO
Explain parameterisations of L
Explain how we search through the parameters
